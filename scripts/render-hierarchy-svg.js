...
async function main() {
    const cap = process.argv[2] && !isNaN(Number(process.argv[2])) ? Number(process.argv[2]) : 4000;
    ...
    for (const [id, b] of blocks) {
        const isLeafParent = [...blocks.values()].some(other => other !== b &&
            other.r0 >= b.r0 && other.r1 <= b.r1 && other.c0 >= b.c0 && other.c1 <= b.c1);
        void isLeafParent;
    }
    ...
    for (const [id, b] of blocks) {
        ...
        const containsOther = [...blocks.values()].some(other => other !== b &&
            other.r0 >= b.r0 && other.r1 <= b.r1 && other.c0 >= b.c0 && other.c1 <= b.c1 &&
            (other.r0 > b.r0 || other.r1 < b.r1 || other.c0 > b.c0 || other.c1 < b.c1));
        if (!containsOther) leafParents.push([id, b]);
    }
    for (const [, b] of leafParents) {
        if (!colorOf.has(b.r0 + '_' + b.c0)) colorOf.set(b.r0 + '_' + b.c0, palette[idx++ % palette.length]);
    ...
    for (const [id, b] of blocks) {
        const isOuter = ![...blocks.values()].some(other => other !== b &&
            other.r0 >= b.r0 && other.r1 <= b.r1 && other.c0 >= b.c0 && other.c1 <= b.c1 &&
            (other.r0 > b.r0 || other.r1 < b.r1 || other.c0 > b.c0 || other.c1 < b.c1));
        if (isOuter) {
    ...
    console.log(`wrote ${out}  (${result.assignments.length} villages, grid ${R}x${C}, ${leafParents.length} leaf-parent blocks)`);
}
